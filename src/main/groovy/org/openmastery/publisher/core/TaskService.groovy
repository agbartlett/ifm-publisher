...
class TaskService {
    ...
    public Page<Task> findRecentTasks(Integer page, Integer perPage) {
        Page<TaskEntity> taskList = persistenceService.findRecentTasks(invocationContext.getUserId(), new PageRequest(page, perPage));
